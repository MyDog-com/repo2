...
<jsp:include page="/WEB-INF/view/commons/footer.jsp"></jsp:include>
	...
	<script type="text/javascript">
		...
		function operationFormatter(value,row,index) {
			var html = "<span onclick='role_edit("+row.roleId+")' class='glyphicon glyphicon-pencil' style='color:green;cursor: pointer;'>&nbsp;&nbsp;&nbsp;</span>";
			html += "<span onclick='role_del("+row.roleId+")' class='glyphicon glyphicon-trash' style='color:red;cursor: pointer;'></span>";
			return html;
		}
		/*
		 参数解释：
		...
		/*角色-增加*/
		function role_add() {
			layer_show("添加角色","role/edit.do","800", "500");
		}
		/*角色-增加*/
		...
		function deleteBatches(){
			...
			console.log(users)
			layer.confirm('确认要删除所选角色吗？', function(index) {
